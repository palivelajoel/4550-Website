...
export default function Hub() {
  ...
  const FEATURES = [
    ...
    { id:"scouting", icon:"🔭", label:"Scouting", description:"REBUILT 2026 match & pit scouting, AI stream scoring, team analysis, picklist.", href:"/member-hub/scouting", accent:"#a855f7" },
