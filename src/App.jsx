        ...
        {['email', 'phone', 'notes'].map(k => (
          <div key={k} style={styles.field}>
            ...
            <input
              ...
              placeholder={k === 'email' ? 'contact@company.com' : k === 'phone' ? '(555) 000-0000' : ''}
            />
          </div>
        ))}
...
export default function App() {
  ...
  const filtered = sponsors.filter(s => {
    ...
    const matchSearch = !q || s.company?.toLowerCase().includes(q) || s.email?.toLowerCase().includes(q)
    ...
    <div style={styles.app}>
      ...
      <div style={styles.main}>
        ...
        <div style={styles.controls}>
          ...
          <button style={{ ...styles.btn, background: 'linear-gradient(135deg,#7c3aed,#4f46e5)' }} onClick={() => setShowImport(true)}>
            📥 IMPORT CSV
          </button>
                ...
                <div key={s.id} style={styles.card}>
                  ...
                  {s.phone && (
                    <div style={styles.fieldRow}>
                      ...
                      <button style={styles.copyBtn} onClick={() => copy(s.phone)}>COPY</button>
                    </div>
                  )}
                  {s.notes && (
                  ...
                  <div style={{ marginTop: '12px' }}>
                    <label style={styles.label}>STATUS</label>
                    <select
                      style={{ ...styles.select, width: '100%', fontSize: '12px', padding: '7px 10px' }}
                      value={s.status}
